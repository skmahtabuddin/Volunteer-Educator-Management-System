...
<div class="topnav">
  ...
  <div class="login-container">
      <li class="nav-item">
			   <a class="nav-link" href="adminbk.php?logout='1'">Logout</a>
			  </li>
  </div>
</div>
  <?php endif ?>
				...
				<div class="col-md-8">
	              ...
	              $result = mysqli_query($db, $query);                  
	                        while($row = $result->fetch_assoc()) {
	                            ...
	                            echo '<td> <a  type="button" class="btn btn-xs btn-danger" href="educator.php?book=' . $row['ID'] . '"> [BOOK]</a> </td>';
	                            echo '</tr> ';
	                }
	            ?> 
